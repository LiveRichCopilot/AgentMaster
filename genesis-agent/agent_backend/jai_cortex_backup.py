...
def call_code_master(task: str, tool_context: ToolContext) -> Dict[str, Any]:
    """Call CodeMaster specialist for code development, debugging, and software engineering.
    ...
    Args:
        task: Description of what code/help is needed
    
    Returns:
        Response from CodeMaster specialist
    """
    return _call_specialist("CodeMaster", task)
