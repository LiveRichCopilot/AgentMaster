...
export const Header = ({ agentStatus, voiceEnabled, onVoiceToggle }: HeaderProps) => {
  return (
    <motion.header
    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="p-2 rounded-xl bg-white/5 text-white/60 hover:bg-white/10 transition-all duration-300">
