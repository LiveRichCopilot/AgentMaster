...
<head>
  ...
  <title>Claude Agent - Your AI Assistant</title>
  <style>
...
<body>
  <div class="header">
    <h1>Claude Agent</h1>
    <button class="api-key-btn" onclick="showApiKeyModal()">Set API Key</button>
  </div>
    ...
    <div class="chat-panel">
      <div class="messages" id="messages">
        <div class="welcome">
          ...
          <p>Start a conversation with Claude AI. Set your API key to begin.</p>
        </div>
      </div>
  ...
  <div class="modal" id="apiKeyModal">
    <div class="modal-content">
      ...
      <div class="modal-actions">
        <button class="cancel-btn" onclick="closeApiKeyModal()">Cancel</button>
  ...
  <script>
    ...
    async function deleteConversation(id) {
      ...
      if (currentConversationId === id) {
        ...
        messages.innerHTML = '<div class="welcome"><h2>Conversation Deleted</h2><p>Start a new conversation to continue.</p></div>';
      }
    ...
    async function sendMessage() {
      ...
      await supabase
        .from('messages')
        .insert({ conversation_id: currentConversationId, role: 'user', content: text });
      ...
      try {
        ...
        if (data.error) {
          ...
          await supabase
            .from('messages')
            .insert({ conversation_id: currentConversationId, role: 'assistant', content: reply });
        ...
        addMessage('Error: Could not connect to Claude API. Check your API key.', false);
      } finally {
        send.disabled = false;
